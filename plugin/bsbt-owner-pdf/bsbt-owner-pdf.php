 ...
 * Description: Owner booking confirmation + payout summary PDF. (V2.1.2 - StayFlow Engine)
 * Version: 2.1.2
...
final class BSBT_Owner_PDF {
   ...
   public static function init() {
        ...
        // Нативный хук MotoPress (на случай, если админ одобряет вручную)
        add_action('mphb_booking_status_confirmed', [__CLASS__, 'on_booking_confirmed'], 20, 1);
        
        // НАШ ЖЕЛЕЗНЫЙ ХУК (Срабатывает после аппрува владельцем)
   ...
   public static function on_booking_confirmed($booking) {
        // Проверяем, что MotoPress передал нам правильный объект брони
   ...
   /* =========================================================
    ...
    private static function generate_pdf(int $bid, array $ctx): array {
        ...
        // RU: Используем PDF движок из нашего ядра StayFlow
    ...
    // RU: ТА САМАЯ ФУНКЦИЯ, КОТОРАЯ ПОТЕРЯЛАСЬ!
