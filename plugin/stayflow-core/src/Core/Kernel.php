 ...
 * Version: 1.1.2
 * RU: Главное ядро инициализации плагина с поддержкой Onboarding и Calendar Sync.
 * EN: Main initialization kernel of the plugin with Onboarding and Calendar Sync support.
 */
...
use StayFlow\BusinessModel\InvoiceModifier; // <-- Импорт есть
...
final class Kernel
{
    ...
    public function boot(): void
    {
        ...
        // =========================================================
        // RU: ИНИЦИАЛИЗАЦИЯ ИНВОЙСОВ (То, что ты забыл добавить)
