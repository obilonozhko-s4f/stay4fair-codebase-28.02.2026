...
final class OwnerStepsShortcode
{
    ...
    {
        // RU: Получаем динамическую комиссию из настроек плагина (по умолчанию 15)
        // EN: Get dynamic commission from plugin settings (default 15)
        $commission = get_option('sf_host_commission', '15');
    ...
    public function render(): string
    {
        ...
        <style>
            ...
            /* Сетка: Десктоп 4 колонки, Планшет 2, Мобайл 1 */
            .sf-steps-grid {
                display: grid;
